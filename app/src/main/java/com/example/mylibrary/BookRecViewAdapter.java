...
public class BookRecViewAdapter extends RecyclerView.Adapter<BookRecViewAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (books.get(position).getExpanded()){
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (new Util(mContext).removeFromAlreadyReadBooks(books.get(position))){
            ...
            else if(parentActivity.equals("wishListBook")){
                holder.btnDelete.setVisibility(View.VISIBLE);
                holder.btnDelete.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                if (new Util(mContext).removeFromWishListBooks(books.get(position))){
                                    Toast.makeText(mContext, name + " Removed", Toast.LENGTH_SHORT).show();
                                    notifyDataSetChanged();
                                }else {
                                    Toast.makeText(mContext, "Try again", Toast.LENGTH_SHORT).show();
                ...
                holder.btnDelete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                if (new Util(mContext).removeFromCurrentlyReadingBooks(books.get(position))){
                                    Toast.makeText(mContext, name + " Removed", Toast.LENGTH_SHORT).show();
                                    notifyDataSetChanged();
                                }else {
                                    Toast.makeText(mContext, "Try again", Toast.LENGTH_SHORT).show();
                ...
                holder.btnDelete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                if (new Util(mContext).removeFromFavouriteBooks(books.get(position))){
                                    Toast.makeText(mContext, name + " Removed", Toast.LENGTH_SHORT).show();
                                    notifyDataSetChanged();
                                }else {
                                    Toast.makeText(mContext, "Try again", Toast.LENGTH_SHORT).show();
